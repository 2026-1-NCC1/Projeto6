...
public class LixeiraComSenha : MonoBehaviour
{
    ...
    private void Interacao()
    {
        ...
        {
            string m = "Há um pedaço de papel jogado.\nNele está escrito \"O carrosel de imagens do Windows é sempre muito PItoresco.\"";
            mensagem = m;
            resposta.DefineMensagem(mensagem);
            visto = true;
        }
